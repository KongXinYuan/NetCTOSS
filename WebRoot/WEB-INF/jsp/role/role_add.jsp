...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            $(function(){
            	...
            	<%session.setAttribute("addFlag", null);%>
            	//检查
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="role_add" method="post" class="main_form" id="roleForm">
                <div class="text_info clearfix"><span>角色名称：</span></div>
                <div class="input_info">
                    <input type="text" class="width200" name="role.name" id="name"/>
                    ...
                    <div class="input_info_scroll">
                        <ul>
                        	<s:iterator value="privileges" var="p">
                           		<li><input name="role.privilegeIds" type="checkbox" value="${p.id }"/>${p.moduleName }</li>
                        	</s:iterator>
                        </ul>
                    </div>
                    <span class="required">*</span>
